        ...
        return (
            ...
            <tbody>
              
              {
                ...
                <td><Link  to={"/votantes/edictar/"+usuario.id} className="btn btn-warning glyphicon glyphicon-wrench"></Link></td>
                <td><Link  to="/votantes" className="btn btn-danger glyphicon glyphicon-trash" onClick={()=>this.borrar(usuario.id)}></Link></td>
