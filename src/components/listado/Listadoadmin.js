...
refrescarusuario=async()=>{
  ...
  const res = await axios.get(enviroments.backendUrl + '/listado');
        ...
        return (
            ...
            <div className="container-fluid">
                ...
                <div className="d-flex justify-content-center">
                  <h1  className="p-5">LISTADOS</h1>
                </div>
                <form className="form-horizontal"  onSubmit={this.onSubmit}> 
                
             <div className="align-self-center ">
                 
             <Link className="btn btn-primary col-md-20 p-2" to="/votantes/crear">CREAR VOTANTE</Link>
                   ...
                   <button className="btn btn-primary col-md-20 p-2
                   " value="" type="onSubmit" name="nombre" onClick={()=>this.consultanombreChange()} >NOMBRE</button>
            ...
            <tbody>
              
              {
                ...
                <td><Link  to={"/listado/ver/"+usuario.id} className="btn btn-primary glyphicon glyphicon-folder-open" ></Link></td>
                <td><Link  to={"/listado/grafica/"+usuario.id}  className="btn btn-info glyphicon glyphicon-stats" ></Link></td>
