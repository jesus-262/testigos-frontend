...
export default class VerListadoEdictar extends Component {
    ...
    verificarurl= async()=>{  
        ...
        const verificarurl=await axios.post(enviroments.backendUrl + '/listado/verificaedictar/',nuevorol)
        console.log(verificarurl.data);
        if(verificarurl.data==false){
           window.location.href = "http://localhost:3000/votantes";
        }
    ...
    edictarRol= async()=>{  
       ...
       // contrasena:this.state.contrasena,
        ...
        await axios.put(enviroments.backendUrl + '/votantes/edictar/'+nuevorol.id,nuevorol)
       /*
    ...
    mostrardepartamentos=async()=>{
      ...
      usuarioedictar=async()=>{
        ...
        const res = await axios.post(enviroments.backendUrl + '/votantes/unrol',params);
    ...
    render() {
        return (
          ...
          <p>Los campos con * son obligatorios</p>
              ...
              <h3>EDICTAR VOTANTE LALALALA</h3>
