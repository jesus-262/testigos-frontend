...
export default class VerListado extends Component {
  state={
    usuario:[],
    navegacion:[],
    cedula:'',
    ...
    */
    ...
    var params={
     ...
     //console.log("this.state.navegacion")
      ...
      renderbotonedictar= (usuario) => {
        if(this.token().tipo!="GESTOR"){
         return  <td><Link  to={"/listado/ver/edictar/"+usuario.id} className="btn btn-warning glyphicon glyphicon-wrench"></Link></td>      
        }
      }
      renderbotoneliminar= (usuario) => {
        if(this.token().tipo!="GESTOR"){
         return  <td><Link   className="btn btn-danger glyphicon glyphicon-trash" onClick={()=>this.borrar(usuario.id)}></Link></td>
        }
      }
    render() {
        ...
        return (
            <div className="container-fluid">
                ...
                <div className="d-flex justify-content-center">
                  <h1  className="p-5">MI LISTADO</h1>
                </div>
            ...
            <tbody>
              
              {
                ...
                {this.renderbotonedictar(usuario)}
                {this.renderbotoneliminar(usuario)}
